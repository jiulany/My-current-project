    ...
    <view class="cosmetology">
            ...
            <view class="cosmetology_box_items">
                <view class="cosmetology_box_item_1">
                    <radio-group @click="radioChange(item)">
                        <radio :value="item.one_sku.id.toString()" :checked="item.checked" color="#FDD000" />
                    </radio-group>
                </view>
        ...
        <view class="cosmetology_footer">
            <view class="cosmetology_footer_item_1">
                <radio-group @click="radioChangeAll">
                    <radio value="2" :checked="allChecked" color="#FDD000" />
                </radio-group>
            ...
            <view class="cosmetology_footer_item_4" @tap="order_buy">
            去结算
            </view>
...
<script>
    ...
    export default {
        ...
        onLoad(options){
            ...
            let service_classify_id = options.service_classify_id
            let data = this.pages
            data.service_classify_id = service_classify_id
            this._getCosmetology(data)
        },
    }
</script>
