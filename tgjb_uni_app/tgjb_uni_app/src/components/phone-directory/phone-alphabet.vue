<template>
	<view class="alphabet">
		<view  class="alphabet-item" @tap="close" style="border-radius:50rpx;background:#eee;margin-bottom:20rpx;display:flex;align-items: center;justify-content: center;"><image style="width:20rpx;height:20rpx" mode="aspectFit" src='https://imgcdn.tuogouchebao.com/property_shanchu.png'></image></view>
