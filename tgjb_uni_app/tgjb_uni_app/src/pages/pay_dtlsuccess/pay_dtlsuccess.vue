<template>
  <view class="span24 paysuccess">
     ...
     <view class="span24 paysuccess-status">缴费成功</view>
     <view class="span24 paysuccess-btn">
         <view class="span12 paysuccess-rtr"><view @tap="toInx">返回首页</view></view>
         <view class="span12 paysuccess-chek"><view  @tap="toMyAppoint">查看缴费</view></view>
     </view>
  </view>
</template>
...
export default {
  ...
  methods: {
      ...
      toMyAppoint(){
          uni.navigateTo({url: `/pages/pay/pay?target=${1}`});
      }
  },
  components: {},
  onLoad(e) {
