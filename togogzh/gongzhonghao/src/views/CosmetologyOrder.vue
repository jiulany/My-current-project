    ...
    <div>
        <v-container class='plo_'>
            <v-layout wrap>
                ...
                <!-- END -->
                <v-flex ref='xclx' xs12 class='plo_it'>洗车类型
                    <span style='position: relative;'>{{cartype}}
                        <span v-if='add_price'>
                            {{'(SUV'+add_moy+')'}}
                        </span>
                        <select v-model='seleCar' style="position:absolute;left: 0;top: 0;opacity: 0">
